...
Mean relative mNET-seq signal is shown below for pause sites identified for TSS (TSS - +500 bp) and gene body (+500 bp - pAS) regions. The sequence preference for each group of sites is shown below each plot. The dotted line indicates the 3' end of the nascent RNA.
