...
The number of pause sites shared between samples and replicates is shown below for the TSS (`r tss_desc`) and gene body (`r body_desc`) regions.
...
NET-seq signal is shown below for pause sites identified for TSS (`r tss_desc`) and gene body (`r body_desc`) regions.
