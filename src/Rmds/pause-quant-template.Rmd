...
```{r "{{grp}} pause reads tss-body boxes", fig.width = 1 + (2.5 * n_common_reps), fig.height = 5}
...
The fraction pause reads is shown below for the first exons/introns and gene body exons/introns, as described above.
