...
Mean eNET-seq signal (top) or mean relative signal (bottom) is shown below for 5' (10 bp bins) and 3' regions (50 bp bins). These plots use files generated without subsampling reads to equalize library sizes.
...
Mean eNET-seq signal is shown below for the region around 5' splice sites.
