...
# * fastqs must end in _R[12]_[0-9]+.fastq.gz or _[0-9]+.fq.gz
fq_sfx <- "(_S[0-9]+_L[0-9]+|)_(R[12]_|)[0-9]+.(fastq|fq).gz$"
...
# RNAs to summarize
# * Configurable per-genome via `qc_biotypes` (must include "unassigned");
#   defaults preserve the original eukaryotic biotype set. Biotypes not listed
#   are collapsed into "other". E. coli configs should list rRNA/tRNA/ncRNA
#   instead of the eukaryote-specific miRNA/snoRNA/snRNA.
rnas <- plot_params$qc_biotypes %||% c(
