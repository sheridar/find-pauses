...
if (!dir.exists(here(params$obj_dir))) {
  dir.create(here(params$obj_dir), recursive = TRUE, mode = "0750")
}

if (!dir.exists(here(params$tab_dir))) {
  dir.create(here(params$tab_dir), recursive = TRUE, mode = "0750")
}
